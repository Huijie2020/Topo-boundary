...
def split_dataset():
    ...
    with open('/mnt/git/Topo-boundary/conn_experiment/dataset_split/1_data_split/growing_contr/iter1_1600image/name_1600from1998.json','r') as jf: # for the first time self-training, use 'name_1600from1998.json'
    ...
    data_1600 = data_sup_add["name_1600from1998"]
    train_sup_img = []
    ...
    train_sup_last = random.sample(data_1600, 1114)
    for i in range(len(train_sup_last)):
        train_sup_new.append(train_sup_last[i])


    with open('/mnt/git/Topo-boundary/conn_experiment/dataset_split/1_data_split/growing_contr/iter1_1600image/data_split_sup1600_unsup1998_growing_image_iter1.json','w') as jf:
