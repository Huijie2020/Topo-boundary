...
#     json.dump({'name_1600from1998_iter':select_name_iter
#                 },jf)
#
...
source_iter_pre_json = '/mnt/git/Topo-boundary/conn_experiment/dataset_split/1_data_split/growing/iter1_1600image/name_1600from1998.json'
...
# union this and pre
union_two_image_list = list_union (select_name, name_1600from1998_pre)
# lenght union_two_image_list
print("union_two_image_list", len(union_two_image_list)) # union_two_image_list 1670

# write to json
with open(source_iter_pre_json,'w') as jf:
